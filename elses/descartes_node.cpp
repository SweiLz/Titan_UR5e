#include <ros/ros.h>
#include <app_core/PlanCartesianPath.h>
...
public:
    CartesianPlanner(ros::NodeHandle &nh)
    {
        ...
        ROS_INFO_STREAM("Start plan_path service server.");
    }
    ...
    bool planPath(app_core::PlanCartesianPathRequest &req,
                  app_core::PlanCartesianPathResponse &res)
    {
